# Contributing to Jentic Arazzo Tools

Thank you for considering contributing to the Jentic Arazzo Tools!
This document outlines the process for contributing to the Jentic Arazzo Tools Repository.
...
-   **[🐛 Bug Report](https://github.com/jentic/jentic-arazzo-tools/issues/new?assignees=&labels=bug&template=Bug_report.md&title=%5BBug%5D+)**
-   **[✨ Feature Request](https://github.com/jentic/jentic-arazzo-tools/issues/new?assignees=&labels=enhancement&template=feature_request.md&title=%5BFeature%5D+)**
...
Thank you for helping build and improve the Jentic Arazzo Tools!
